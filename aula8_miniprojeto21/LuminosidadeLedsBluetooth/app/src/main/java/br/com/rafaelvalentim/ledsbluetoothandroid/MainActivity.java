...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seekBarLed.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            int progress = 0;
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                System.out.println(String.valueOf((int)progress/10));
                sendData(String.valueOf((int)progress/10));
            }
        });
    }
    @Override
...
// Emulator doesn't support Bluetooth and will return null
    ...
    public void fazerConexoesDoLayoutListeners() {
        ...
        btnLedYellow = (Button) findViewById(R.id.btnLedYellow);
        btnLedGreen = (Button) findViewById(R.id.btnLedGreen);
        btnLedWhite = (Button) findViewById(R.id.btnLedWhite);

        btnLedRed.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                sendData("r");
            }
        });
        btnLedYellow.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                sendData("y");
            }
        });
        ...
        btnLedWhite.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                sendData("w");
